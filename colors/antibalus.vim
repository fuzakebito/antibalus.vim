...
if &diff
  call s:hi('CursorLine', s:palette.none, s:palette.none, 'underline')
  call s:hi('CursorColumn', s:palette.none, s:palette.none, 'bold')
else
...
if &diff
  call s:hi('CursorLineNr', s:palette.g3, s:palette.g0, 'underline')
else
  call s:hi('CursorLineNr', s:palette.g3, s:palette.g0)
endif
...
call s:hi('NormalFloat', s:palette.g5, s:palette.g0)
